...
const Vehiclelist = ({ columns }) => {
  ...
  function generatePDF(tickets) {
    ...
    doc.text("ReachMe Travels-Vehicle-Details-Report ", 14, 15).setFontSize(12);
    ...
    <>
      <div className="flex flex-row col-span-2 lg:px-32 px-8 pt-7 pb-2 justify-between md:items-center ">
        ...
        <div className="grid md:grid-cols-2 gap-1">
          <Link
            to="/vehicle/add"
            className="bg-purple-600 hover:bg-purple-600 text-center text-white font-bold py-2 px-4 rounded cursor-pointer lg:mt-0 mt-3"
          >
            Add Vehicle
          </Link>
          <Link
