      ...
      <div className="grid lg:grid-cols-2 gap-8 md:px-24 p-4 sm:py-8">
        <div className="flex flex-col justify-center items-center md:m-20 m-5 py-10 gap-5 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
          <div className="text-center mx-6 pt-3 pb-3">
            <h1 className="text-3xl font-bold text-[#B399DD]">
              Update User Details
            </h1>
          </div>
          <div>
            <img
              className="w-52 h-52 rounded-full shadow-lg border-4 border-purple-500 object-cover"
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-2">
              ...
              <label className="flex flex-col items-start">
                ...
                <div className="relative">
                  ...
                  >
                   ...
                   <option value="tour manager" className="text-gray-900">
                      Tour Manager
                    </option>
                    <option value="vehicle owner" className="text-gray-900">
                      Vehicle Owner
                    </option>
                    <option value="hotel owner" className="text-gray-900">
                      Hotel Owner
                    </option>
                    <option value="train manager" className="text-gray-900">
                      Train Manager
                    </option>
                     </select>
                  <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
            ...
            <div>
              <label htmlFor="file" className="flex items-center mb-5 mt-2">
                <span className="pr-3">
                  Click here to edit a profile picture:
                </span>
            ...
            <div>
              <button
                className="bg-purple-500 w-full p-3 rounded-xl text-white font-bold mb-5"
                type="submit"
              >
                Update Profile
              </button>
