...
const ReviewTickets = () => {
    ...
    const generateReport = () => {
        ...
        doc.setFontSize(20);
        doc.setTextColor("#B399DD"); // Set text color to blue
        ...
        headers.forEach((header) => {
            doc.setFillColor("#DEEFFF"); // Set fill color to blue
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="flex justify-end mb-6">
                ...
                {
                    approved && (
                        <button className="bg-purple-600 hover:bg-red-600 text-white px-6 py-2 rounded-lg shadow-md" onClick={generateReport}>
                            Download Ticket
                        </button>
                    )
                }
