...
import welcome from "../../assets/Tour/sri_lanka_1.jpg";
      ...
      <nav class="bg-grey-light w-full rounded-md pl-20 pt-10">
        <ol class="list-reset flex">
          <li>
            <Link
              to={"/"}
              class="text-purple-600 transition duration-150 ease-in-out hover:text-purple-600 focus:text-purple-600 active:text-purple-700 dark:text-purple-400 dark:hover:text-purple-500 dark:focus:text-purple-500 dark:active:text-purple-600"
            >
              Home
            </Link>
          </li>
