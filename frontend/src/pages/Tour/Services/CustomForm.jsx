    ...
    <div className="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8">
      <div className="mt-6 grid grid-cols-1 gap-x-6   lg:grid-cols-2 xl:gap-x-8 ">
        ...
        <div className="shadow-2xl flex justify-center items-center">
          <div>
            <p className="items-center text-8xl p-3 flex justify-center text-purple-600">
              <TbMap2 />
            </p>
            <h2
              ...
              <div>
                <div>
                  ...
                  <div class="relative mb-3" data-te-input-wrapper-init>
                    ...
                    <input
                      type="text"
                      class=" min-h-[auto] w-full rounded-lg  input border-4 divide-purple-400"
              ...
              <div>
                <div>
                  ...
                  <div class="relative mb-3" data-te-input-wrapper-init>
                    ...
                    <input
                      type="text"
                      class=" min-h-[auto] w-full rounded-lg  input border-4 dborder-purple-500"
                      id="exampleFormControlInputText"
                      onChange={(e) => {
