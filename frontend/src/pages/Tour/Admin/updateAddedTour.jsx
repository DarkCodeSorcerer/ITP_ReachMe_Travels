    ...
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-4 sm:py-15 lg:max-w-7xl lg:px-8">
      <form>
        <div className="space-y-12">
          ...
          <div>
            ...
            <div>
              ...
              >
                Edit a cover photo for the package
              </label>
              ...
              <div className="mb-6 flex flex-row justify-center items-center text-center mt-12">
                <label htmlFor="file">
                  click below Icon to edit a Cover Photo :{" "}
                  <TbPhotoPlus
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                ...
                <p className="text-sm">
                  ...
                  and then you wish to travel colombo to some where))
                </p>
                <div className="mt-2">
                  <input
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          ...
          <button
            type="submit"
            className="rounded-md bg-black px-3 py-2 text-lg font-semibold text-white shadow-sm hover:bg-purple-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600"
