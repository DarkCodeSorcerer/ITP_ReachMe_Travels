...
const AddTourPackage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // Validate tourName to contain only letters
    const namePattern = /^[A-Za-z\s]+$/; // Allow letters and spaces
    if (!namePattern.test(name)) {
      Swal.fire({
        icon: 'error',
        title: 'Invalid Tour Name',
        text: 'Tour name should contain only letters and spaces.',
      });
      return;
    }
    ...
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-4 sm:py-15 lg:max-w-7xl lg:px-8">
      <form>
        <div className="space-y-12">
          {/* basic details */}
          <div>
            <h2 className="text-3xl font-semibold leading-7 text-[#B399DD] text-center">
              Add Tour Package
            </h2>
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-600 sm:text-sm sm:leading-6"
                    onChange={(e) => {
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          ...
          <button
            type="submit"
            className="rounded-md bg-black px-3 py-2 text-lg font-semibold text-white shadow-sm hover:bg-[#B399DD] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600"
