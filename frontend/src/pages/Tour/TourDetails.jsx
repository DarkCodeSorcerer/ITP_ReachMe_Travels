        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-8">
          ...
          <div className="">
            ...
            <div className="mt-5 grid grid-cols-2 gap-2">
              ...
              <div>
                <img
                  src="https://elements-resized.envatousercontent.com/envato-shoebox/96d9/7c2b-008e-437f-9cc8-7308ecbf29df/263535424.jpg?w=800&cf_fit=scale-down&mark-alpha=18&mark=https%3A%2F%2Felements-assets.envato.com%2Fstatic%2Fwatermark4.png&q=85&format=auto&s=2d6f347e5414691b16f8a0e0dfb8fd9a82b98f6c31cf25d563121759cbf03c58"
                  alt=""
                />
              </div>
              {/* right */}
          ...
          {/* details -right*/}
          <div className="shadow-2xl rounded-xl border-dotted border-2 border-purple-500 grid grid-cols-1 px-4">
            <div>
              {/* first row */}
              <div className="grid grid-cols-2">
                ...
                <div>
                  ...
                  <p className="p-3 ml-10 text-purple-600  text-5xl">
                    <span className="font-semibold">LKR{allTours.price}</span>
              ...
              <div className="flex flex-row pl-10 pt-2 pr-2 space-x-3 mb-4">
                ...
                <p className="text-xl  mb-0   text-purple-500">
                  {allTours.cities}
                </p>
              </div>
              ...
              <div className="text-xl p-2 grid grid-cols-2">
                ...
                {/* <div>
                  <button
                    type="button"
                    class=" w-full rounded-xl bg-[#FE4D42] px-6 pb-2 pt-2.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-purple-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-purple-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-purple-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
                  >
                    Customize Your Tour
                  </button>
                </div> */}
                  ...
                  <form>
                    <div class="grid grid-cols-2 gap-4">
                      <div class="relative mb-6" data-te-input-wrapper-init>
                        ...
                        <label
                          for="firstName"
                          class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-black-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-purple-600 peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-gray-500 dark:peer-focus:text-purple-600"
                        >
                          First name
                        </label>
                      </div>
                      <div class="relative mb-6" data-te-input-wrapper-init>
                        ...
                        <label
                          for="lastName"
                          class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-purple-600 peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-gray-500 dark:peer-focus:text-purple-600"
                        >
                          Last name
                        </label>
                      </div>
                    ...
                    >
                      <input
                        ...
                        class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-purple-600 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-black dark:placeholder:text-neutral-200 dark:peer-focus:text-purple-600 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
