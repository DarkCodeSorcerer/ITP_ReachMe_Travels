    ...
    <>
      <div className="grid lg:grid-cols-2 gap-8 md:px-24 p-4 sm:py-8">
        <div className="flex flex-col justify-center items-center lg:py-24 py-10 gap-5 md:m-20 m-5 rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
          <div>
            <img
              className="w-48 h-48 rounded-full shadow-lg border-4 border-purple-500 object-cover"
              src={`${user.img}`}
              alt=""
            />
          </div>
        ...
        <div className="flex flex-col justify-center items-start gap-5 rounded-lg bg-white p-6">
          ...
          <h3 className="text-purple-500 text-xl font-bold">{user.type}</h3>
          ...
          <div className="flex flex-col md:flex-row gap-5 mt-14">
            <button
              className="bg-purple-500 py-3 px-6 rounded-lg text-white font-bold hover:bg-purple-600 transition duration-200 ease-in-out"
              onClick={getUser}
            >
              Update Profile
            </button>
            ...
            {user.type === "traveler" && (
              <>
                <Link to="/my-reservations">
                  <button className="bg-purple-500 py-3 px-6 rounded-lg text-white font-bold hover:bg-purple-600 transition duration-200 ease-in-out">
                    My Reservations
                  </button>
                </Link>
              </>
            ...
            {user.isAdmin && (
              <>
                <Link to="/pending-activities">
                  <button className="bg-purple-500 p-3 rounded-xl text-white font-bold">
                    Pending Activities
                  </button>
                </Link>
              </>
