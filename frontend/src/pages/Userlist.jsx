...
const Userlist = ({ columns }) => {
  ...
  function generatePDF(tickets) {
    ...
    doc.setFontSize(20).setTextColor(179, 153, 221); // set font size and purple color
    doc.setFont("helvetica", "bold");
    doc.text("ReachMe Travels", 14, 15); // add heading
    ...
    doc
      .text("69 Walpole place, Brookhill road, woolwich, SE186TR,London", 14, 37)
      .setFontSize(10);
    ...
    <>
      <div className="flex flex-row col-span-2 lg:px-32 px-8 pt-8 justify-between md:items-center ">
        ...
        <div className="grid md:grid-cols-2 gap-1">
          <Link
            to="/adduser"
            className="bg-purple-500 flex justify-center items-center hover:bg-purple-700 text-white font-bold py-2 px-4 rounded cursor-pointer lg:mt-0 mt-3"
          >
            Add User
          </Link>
          <button
