...
export const AddRoom = () => {
  ...
  return (
    <div className="flex justify-center">
      ...
      >
        <h1 className="text-2xl font-bold mb-8 mt-5">Customize Your <span class='text-[#B399DD]'>Rooms</span></h1>
       ...
       <div className="mb-5">
          <button class="bg-[#B399DD] hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-full " >
          SUBMIT
        </button>
