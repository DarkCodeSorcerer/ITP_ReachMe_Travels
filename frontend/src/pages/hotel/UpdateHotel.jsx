 ...
 // const [noOfRoomTypes, setNoOfRoomTypes] = React.useState("");
  ...
  return (
    <div className="flex justify-center">
      ...
      >
        <h1 className="text-2xl font-bold mb-8 mt-8">Update <span class='text-[#B399DD]'>Hotel</span> and <span class='text-[#B399DD]'>Join</span> with us</h1>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full md:w-1/2 px-3  md:mb-0">
            ...
            <select
              ...
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-600 focus:border-purple-500 block w-full p-2.5"
        ...
        <button class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-full mb-8">
          Update
        </button>
      </form>
    </div>
