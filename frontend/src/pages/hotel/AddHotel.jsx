    ...
    <div className="flex justify-center">
      ...
      >
        <h1 className="text-2xl font-bold mb-8 mt-8">
          List Your <span class="text-[#B399DD]">Hotel</span> and{" "}
          <span class="text-[#B399DD]">Join</span> with us
        </h1>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full md:w-1/2 px-3  md:mb-0">
            <label
              ...
              class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
            >
              Select Your Hotel Reservation Type
            </label>
            <select
              id="hotelType"
            ...
            >
              <option>--Add Reservation type</option>
              <option>Hotel</option>
        ...
        <button class="bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-full mb-8">
          SUBMIT
        </button>
