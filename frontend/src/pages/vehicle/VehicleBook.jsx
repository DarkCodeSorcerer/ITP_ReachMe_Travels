      ...
      <div className="flex justify-center items-center w-full flex-col lg:flex-row pt-12 lg:pt-0">
        ...
        <div className="lg:px-24">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              <h1 className="text-[#B399DD]">Free Cancellation</h1>
            </div>
          </div>
          ...
          <div className="pt-4 flex">
            <h1 className="text-[#B399DD] font-bold">Do you need a Driver?</h1>
          ...
          <div className="flex flex-col md:flex-row mt-6  py-2 justify-between lg:items-center">
            <div className="flex items-center">
              ...
              <button className="bg-purple-600 text-white rounded-md lg:ml-8 font-bold p-3 my-5 lg:my-0 w-full md:w-[350px] md:my-0 lg:w-[300px] " type="submit">
                Reserve
              </button>
