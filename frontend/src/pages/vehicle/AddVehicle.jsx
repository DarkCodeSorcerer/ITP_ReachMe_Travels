  ...
  return (
    <div className='p-4 text-[#383838]  justify-center lg:px-96'>
        ...
        <form onSubmit={sendData} encType='multipart/form-data'>
            ...
            <input type='text' className='border rounded-lg w-full p-2 mb-6 mt-2' placeholder='Dineshkumar' onChange={(e) => setOwnerName(e.target.value) } required/>

            <label for className='lg:text-lg text-left'>Vehicle Brand Name</label>
            <input type='text' className='border rounded-lg w-full p-2 mb-6 mt-2' placeholder='Toyota' onChange={(e) => setBrandName(e.target.value) } required/>

            <label for className='lg:text-lg text-left'>Vehicle Model</label>
            <input type='text' className='border rounded-lg w-full p-2 mb-6 mt-2' placeholder='Pirus' onChange={(e) => setModel(e.target.value) } required/>
          ...
          <input type='text' className='border rounded-lg w-full p-2 mb-6  mt-2' placeholder='CAC-1668' onChange={(e) => setVehicleNumber(e.target.value) } required/>
          ...
          <button className="bg-purple-600 text-white rounded-md font-bold p-3 my-5 lg:my-0  w-full ">
                Add Vehicle
              </button>
          <button className="bg-purple-600 text-white rounded-md font-bold p-3 lg:ml-6   w-full mb-12 lg:mb-0" type = 'reset'>
                Reset
              </button>
          </div>
