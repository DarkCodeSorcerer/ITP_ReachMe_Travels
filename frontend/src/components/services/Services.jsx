          ...
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
              <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
                <span class="text-purple-400 mb-2 block text-lg font-semibold">
                  Our Services
                </span>
                ...
                ReachMe Travels, we offer a range of services including customized travel packages, seamless transportation, guided tours, and 24/7 customer support. Whether it's adventure, relaxation, or cultural exploration, we've got you covered!
                </p>
              </div>
            </div>
          </div>
