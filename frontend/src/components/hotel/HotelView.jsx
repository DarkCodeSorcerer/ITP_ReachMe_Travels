        ...
        <div className="flex justify-center items-center w-full flex-col lg:flex-row pt-12 lg:pt-0">
          ...
          <div className="lg:px-24">
            ...
            <div className="flex flex-col md:flex-row py-4">
              <h1 className="text-[#B399DD] font-semibold">Perfect for a {day_difference} night stay!</h1>
            </div>
            ...
            <div className="flex flex-col md:flex-row  py-4 justify-between lg:items-center">
              ...
              <button onClick={handleClick} className="bg-[#B399DD] text-white rounded-md lg:ml-8 font-bold p-3 my-5 lg:my-0 w-full md:w-[350px] md:my-0 lg:w-[300px] ">
                Reserve now
              </button>
