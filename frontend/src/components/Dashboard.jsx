...
//                 </div>
//                 <FaRegCalendarMinus fontSize={28} color="" />
//              </div> <div className='h-[100px] rounded-[8px] bg-white border-l-[4px] border-[#B399DD] flex items-center justify-between px-[30px] cursor-pointer hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out'>
//                 <div>
