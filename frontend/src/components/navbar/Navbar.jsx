  ...
  return (
    <nav className="flex justify-around w-full py-4 bg-gray-50 sticky top-0 z-[999]">
      ...
      <div className="items-center hidden space-x-5 md:flex">
        ...
        <Link to="http://localhost:3000/complaint-form">Contact us</Link>
        <Link to="http://localhost:3000/feedback">Feedback</Link>
      </div>
      ...
      <div className="items-center space-x-3 hidden md:flex">
        {user ? (
            ...
            <Menu as="div" className="relative inline-block text-left">
              ...
              >
                <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  <div className="py-1">
                    <h2 className="block px-4 py-2 text-sm text-[#B399DD]">
                      {user.name}
                    </h2>
                    <Menu.Item>
                      {({ active }) => (
          ...
          <>
            <Link
              to="/login"
              className="px-4 py-2 text-white font-bold bg-[#B399DD] text-center hover:bg-purple-600 cursor-pointer rounded-md"
            >
              Sign in
            </Link>
            <Link
      ...
      >
        <h1 className="text-2xl font-medium text-[#B399DD] m-8">ReachMe Travels</h1>
        <ul className="p-4 mt-20">
          ...
          {/* <li className="p-4 border-b border-grey-600">
          ...
          {user ? (
            <>
              ...
              <Menu as="div" className="relative inline-block text-left p-4">
                <div>
                  ...
                  <h2 className="block py-2 text-sm text-[#B399DD]">
                    {user.name}
                  </h2>
                </div>
            ...
            <>
              <li className="p-4 mt-8">
                <Link
                  to="/login"
                  className="px-3 py-2 text-sm text-white font-bold bg-[#B399DD] text-center hover:bg-purple-600 cursor-pointer rounded-md"
                >
                  Sign in
                </Link>
                <Link
