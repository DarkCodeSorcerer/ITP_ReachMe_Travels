  ...
  return (
    <nav className="flex justify-between lg:px-32 md:px-22 px-12 w-full py-4 bg-gray-50 sticky top-0 z-[999]">
      <div className="flex items-center">
        <Link to="/admin" className="text-2xl font-bold text-[#B399DD]">
          ReachMeAdmin
        </Link>
      </div>
      ...
      >
        <Link to="/admin" className="text-2xl font-medium text-[#B399DD] m-8">
          ReachMe Travels
        </Link>
        <ul className="px-4">
          {user ? (
            ...
            <>
              <li className="p-4 mt-8">
                <Link
                  to="/login"
                  className="px-3 py-2 text-sm text-blue-100 bg-purple-600 rounded-md"
                >
                  Sign in
                </Link>
                <Link
